...
const projects = [
  {
    ...
    story:
      "A focused career command centre that turns scattered applications, interviews and follow-ups into one dependable system.",
  ...
  },
  {
    ...
    story:
      "A premium coffee-ordering experience where a structured Java backend meets a calm, hospitality-led interface.",
  ...
  },
  {
    ...
    story:
      "A practical learning environment that helps developers understand Git through stages, commands, decisions and visual feedback.",
  ...
  },
  {
    ...
    story:
      "An immersive journey through astronomy, the ISS, cosmic theories, timelines, galleries and black holes.",
    stack: ["React", "NASA APIs", "JavaScript", "CSS"],
    links: [
      {
        label: "Visit live project",
        href: "https://astro-stellar-verse.vercel.app/",
      },
    ],
    tone: "cosmic",
  },
...
const notes = [
  {
    ...
    summary:
      "The practical decisions, common mistakes and trade-offs beginners rarely see in tutorials.",
    status: "Published",
  ...
  },
  {
    ...
    summary:
      "A clear account of protecting routes, handling tokens and learning where authentication can fail.",
  ...
  },
  {
    ...
    summary:
      "Why a mental model of commits, branches and state is more useful than another command cheat sheet.",
    status: "Publishing soon",
    href: null,
  },
];
...
const capabilities = [
  {
    ...
    skills:
      "Java · Spring Boot · REST APIs · Spring Security · JWT · JDBC · Servlets",
  ...
  },
  {
    ...
    skills:
      "Responsive design · Component systems · UI/UX · Figma · Accessibility",
    ...
    <main>
      ...
      <nav className="site-nav" aria-label="Primary navigation">
        <a
          ...
          href="#top"
          aria-label="Kumaravel, back to top"
        >
          Kumaravel<span>.</span>
        </a>
      ...
      <section className="hero" id="top" aria-labelledby="hero-title">
        ...
        <div className="hero__copy">
          ...
          <p className="hero__statement">
            I engineer dependable backend systems and shape them into thoughtful
            digital products.
          </p>
      ...
      <section className="introduction section-light" id="introduction">
        ...
        <div className="introduction__body reveal">
          ...
          <h2>
            I build systems that feel as good as they <em>work.</em>
          </h2>
          <div className="introduction__detail">
            <p>
              I turn complex requirements into dependable full-stack
              products—from secure Java APIs to interfaces people can understand
              immediately.
            </p>
            <a href="#work">
              Explore selected work <ExternalArrow />
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="work section-dark" id="work">
        <div className="section-index section-index--dark reveal">
          <span>02</span>
          <p>Selected work</p>
        </div>
        ...
        <div className="project-list">
          {projects.map((project) => (
            <article
              className={`project project--${project.tone} reveal`}
              key={project.number}
            >
      ...
      <section className="about section-light" id="about">
        ...
        <div className="about__body reveal">
          <div>
            ...
            <h2>
              Building the engineering underneath—and caring about every detail
              people <em>touch.</em>
            </h2>
          </div>
          <div className="about__story">
            <p>
              I’m a Computer Science and Business Systems graduate focused on
              Java full-stack development. I started with Java, JDBC and
              Servlets, then moved into Spring Boot APIs, React applications and
              product design.
            </p>
            <p>
              For me, development is more than making a feature work. It means
              understanding the problem, engineering a reliable system and
              presenting it through an interface that feels considered.
            </p>
          </div>
      ...
      <section className="lab section-dark" id="lab">
        ...
        <div className="lab__body reveal">
          <div className="lab__copy">
            <p className="eyebrow">
              <span className="status-dot" /> SYSTEM IN DEVELOPMENT
            </p>
            <h2>
              The next system is already taking <em>flight.</em>
            </h2>
            <h3>Industrial Drone Gas Monitoring Platform</h3>
            <p>
              A mission-control platform for hazardous-gas readings, live drone
              telemetry, alerts, mission logs and historical environmental
              analytics.
            </p>
            <ul>
          ...
          <div
            className="telemetry"
            aria-label="Conceptual drone telemetry panel"
          >
        ...
        <p className="lab__statement reveal">
          Completed work shows what I can deliver.{" "}
          <span>The Lab shows where I’m heading.</span>
        </p>
      </section>
      ...
      <section className="notes section-paper" id="notes">
        ...
        <header className="notes__header reveal">
          ...
          <p>
            Projects show the result. Field Notes reveal the decisions behind
            it.
          </p>
        </header>
      ...
      <section className="capabilities section-light" id="capabilities">
        ...
        <div className="capabilities__body reveal">
          <header>
            ...
            <h2>
              From database schema to the final <em>interaction.</em>
            </h2>
          </header>
          ...
          <blockquote>
            I don’t collect technologies. I use them together to turn an idea
      ...
      <section className="contact" id="contact">
        ...
        <div className="contact__status reveal">
          <i />
          <span>AVAILABLE FOR OPPORTUNITIES</span>
        </div>
        <div className="contact__body reveal">
          ...
          <a className="contact__email" href="mailto:kumaravel007650@gmail.com">
          ...
          <div className="contact__actions">
            ...
            <a
              href="https://github.com/Dev-Venom"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.linkedin.com/in/kumaravel-saravanan/"
              target="_blank"
              rel="noreferrer"
            >
